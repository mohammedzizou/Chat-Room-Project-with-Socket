...
class UserAvatar extends StatelessWidget {
  const UserAvatar(
      {required this.userid, this.size = 48, this.onTap, super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AvatarCubit, AvatarState>(
      bloc: AvatarCubit(
          userid: userid, userRepository: context.read<UserRepository>()),
                ...
                children: [
                  OverflowBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.cover,
                      child: Image.memory(
                          base64.decode(state.userInfo.avatarEncoded!)),
                    ),
                  ),
                  Material(
                    color: Colors.transparent,
