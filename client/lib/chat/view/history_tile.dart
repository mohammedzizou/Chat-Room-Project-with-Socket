...
class HistoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      mainAxisAlignment: history.type == ChatHistoryType.income
        ...
        if (history.type == ChatHistoryType.income) ...[
          Expanded(
              ...
              child: Row(
                ...
                children: [
                  UserAvatar(
                    userid: history.message.senderID,
                    size: 25,
                  ),
                  const SizedBox(
                    width: 16.0,
                  ),
                  Flexible(child: InMessageBox(history: history)),
                ],
              )),
          const Spacer(
            flex: 1,
        ...
        if (history.type == ChatHistoryType.outcome) ...[
          ...
          Expanded(
              ...
              child: Row(
                ...
                children: [
                  Flexible(
                    child: history.message.type == MessageType.image
                        ? Row(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context
                                            .read<ChatCubit>()
                                            .tcpRepository
                                            .pushRequest(SendMessageRequest(
